  ...
  return(
    <div id="welcome" className='wrap'>
      ...
      <div id="welcome_banner">
        ...
        <ul><img src={Arrow} alt="Fleche verte" style={{transform: 'rotate(180deg)'}} />Marketing, communication et publicité</ul>
        ...
        <p>A l'exclusion des formations en ligne et des prestations électroniques comme l'hébergement et la fourniture de sites web ainsi que la maintenance de logiciels.</p>
